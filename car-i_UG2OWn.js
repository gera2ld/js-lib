import { CarIndexer as l } from "https://cdn.jsdelivr.net/npm/@ipld/car@5.2.5/+esm";
import { createDirectoryEncoderStream as p, CAREncoderStream as u } from "https://cdn.jsdelivr.net/npm/ipfs-car@1.1.0/+esm";
import { recursive as w } from "https://cdn.jsdelivr.net/npm/ipfs-unixfs-exporter@13.2.5/+esm";
async function h(n) {
  const e = [];
  await p(n).pipeTo(
    new WritableStream({
