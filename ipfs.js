import { fetchBlob as w, forwardFunction as p, memoize as h } from "./util.js";
const I = "https://dweb.link";
var l;
const f = /\.ip[fn]s\.localhost$/.test(
  (l = globalThis.location) == null ? void 0 : l.hostname
), D = d(import.meta.url), u = h(async () => {
...
const j = p(
  () => import("./car-i_UG2OWn.js").then(({ packCar: t }) => t)
), v = p(
  () => import("./car-i_UG2OWn.js").then(({ listCar: t }) => t)
);
export {
