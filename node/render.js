...
var Se = /^-?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?$/i, ae = Math.ceil, q = Math.floor, C = "[BigNumber Error] ", Ee = C + "Number primitive has more than 15 significant digits: ", z = 1e14, O = 14, he = 9007199254740991, pe = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10, 1e11, 1e12, 1e13], Y = 1e7, R = 1e9;
function Ne(h) {
  var p, m, N, w = g.prototype = { constructor: g, toString: null, valueOf: null }, M = new g(1), x = 20, S = 4, L = -7, y = 21, Z = -1e7, H = 1e7, J = !1, b = 1, W = 0, se = {
    prefix: "",
    groupSize: 3,
  ...
  function g(e, r) {
    ...
    if (r == null) {
      ...
      if ((n = typeof e == "number") && e * 0 == 0) {
        ...
        if (!Se.test(c = String(e))) return N(o, c, n);
      ...
      n = !1, c = m(c, r, 10, o.s), (f = c.indexOf(".")) > -1 ? c = c.replace(".", "") : f = c.length;
    }
  ...
  g.clone = Ne, g.ROUND_UP = 0, g.ROUND_DOWN = 1, g.ROUND_CEIL = 2, g.ROUND_FLOOR = 3, g.ROUND_HALF_UP = 4, g.ROUND_HALF_DOWN = 5, g.ROUND_HALF_EVEN = 6, g.ROUND_HALF_CEIL = 7, g.ROUND_HALF_FLOOR = 8, g.EUCLID = 9, g.config = g.set = function(e) {
    ...
    return function(i, l, t, f, u) {
      var n, s, c, o, a, d, E, _, P = i.indexOf("."), B = x, A = S;
      for (P >= 0 && (o = W, W = 0, i = i.replace(".", ""), _ = new g(l), d = _.pow(i.length - P), W = o, _.c = r(
        V(G(d.c), d.e, "0"),
        10,
        t,
        e
      ), _.e = _.c.length), E = r(i, l, t, u ? (n = Q, e) : (n = e, Q)), c = o = E.length; E[--o] == 0; E.pop()) ;
      if (!E[0]) return n.charAt(0);
      if (P < 0 ? --c : (d.c = E, d.e = c, d.s = f, d = p(d, _, B, A, t), E = d.c, a = d.r, c = d.e), s = c + B + 1, P = E[s], o = t / 2, a = a || s < 0 || E[s + 1] != null, a = A < 4 ? (P != null || a) && (A == 0 || A == (d.s < 0 ? 3 : 2)) : P > o || P == o && (A == 4 || a || A == 6 && E[s - 1] & 1 || A == (d.s < 0 ? 8 : 7)), s < 1 || !E[0])
    ...
    function e(l, t, f) {
      var u, n, s, c, o = 0, a = l.length, d = t % Y, E = t / Y | 0;
      for (l = l.slice(); a--; )
        s = l[a] % Y, c = l[a] / Y | 0, u = E * s + c * d, n = d * s + u % Y * Y + o, o = (n / f | 0) + (u / Y | 0) + E * c, l[a] = n % f;
    ...
    return function(l, t, f, u, n) {
      var s, c, o, a, d, E, _, P, B, A, v, T, re, ce, ue, X, ee, F = l.s == t.s ? 1 : -1, D = l.c, I = t.c;
      if (!D || !D[0] || !I || !I[0])
        return new g(
      ...
      if (I[o] > (D[o] || 0) && c--, F < 0)
        ...
        for (ce = D.length, X = I.length, o = 0, F += 2, d = q(n / (I[0] + 1)), d > 1 && (I = e(I, d, n), D = e(D, d, n), X = I.length, ce = D.length), re = X, A = D.slice(0, X), v = A.length; v < X; A[v++] = 0) ;
        ee = I.slice(), ee = [0].concat(ee), ue = I[0], I[1] >= n / 2 && ue++;
        do {
          if (d = 0, s = r(I, A, X, v), s < 0) {
            if (T = A[0], X != v && (T = T * n + (A[1] || 0)), d = q(T / ue), d > 1)
              for (d >= n && (d = n - 1), E = e(I, d, n), _ = E.length, v = A.length; r(E, A, _, v) == 1; )
                d--, i(E, X < _ ? ee : I, _, n), _ = E.length, s = 1;
            else
              d == 0 && (s = d = 1), E = I.slice(), _ = E.length;
            if (_ < v && (E = [0].concat(E)), i(A, E, v, n), v = A.length, s == -1)
              for (; r(I, A, X, v) < 1; )
                d++, i(A, X < v ? ee : I, v, n), v = A.length;
          } else s === 0 && (d++, A = [0]);
          B[o++] = d, A[0] ? A[v++] = D[re] || 0 : (A = [D[re]], v = 1);
  ...
  N = /* @__PURE__ */ (function() {
    ...
    return function(f, u, n, s) {
      ...
      if (l.test(o))
        ...
        if (!n && (o = o.replace(e, function(a, d, E) {
          return c = (E = E.toLowerCase()) == "x" ? 16 : E == "b" ? 2 : 8, !s || s == c ? d : a;
  ...
  function U(e, r, i, l) {
    var t, f, u, n, s, c, o, a = e.c, d = pe;
    if (a) {
      e: {
        for (t = 1, n = a[0]; n >= 10; n /= 10, t++) ;
        if (f = r - t, f < 0)
          f += O, u = r, s = a[c = 0], o = q(s / d[t - u - 1] % 10);
          ...
          f %= O, u = f - O + t, o = u < 0 ? 0 : q(s / d[t - u - 1] % 10);
        }
        if (l = l || r < 0 || // Are there any non-zero digits after the rounding digit?
        // The expression  n % pows10[d - j - 1]  returns all digits of n to the right
        // of the digit at j, e.g. if n is 908714 and j is 2, the expression gives 714.
        a[c + 1] != null || (u < 0 ? s : s % d[t - u - 1]), l = i < 4 ? (o || l) && (i == 0 || i == (e.s < 0 ? 3 : 2)) : o > 5 || o == 5 && (i == 4 || l || i == 6 && // Check whether the digit to the left of the rounding digit is odd.
        (f > 0 ? u > 0 ? s / d[t - u] : 0 : a[c - 1]) % 10 & 1 || i == (e.s < 0 ? 8 : 7)), r < 1 || !a[0])
          return a.length = 0, l ? (r -= e.e + 1, a[0] = d[(O - r % O) % O], e.e = -r || 0) : a[0] = e.e = 0, e;
        if (f == 0 ? (a.length = c, n = 1, c--) : (a.length = c + 1, n = d[O - f], a[c] = u > 0 ? q(s / d[t - u] % d[u]) * n : 0), l)
          for (; ; )
            if (c == 0) {
  ...
  return w.absoluteValue = w.abs = function() {
    ...
    var i, l, t, f, u, n, s, c, o, a, d, E, _, P, B, A = this, v = A.c, T = (e = new g(e, r)).c;
    if (!v || !T || !v[0] || !T[0])
    ...
    for (P = z, B = Y, t = a; --t >= 0; ) {
      for (i = 0, d = T[t] % B, E = T[t] / B | 0, u = s, f = t + u; f > t; )
        c = v[--u] % B, o = v[u] / B | 0, n = E * c + o * d, c = d * c + n % B * B + _[f] + i, i = (c / P | 0) + (n / B | 0) + E * o, _[f--] = c % P;
      _[f] = i;
    }
    ...
    if (l = t.toFixed(e, r), t.c) {
      var f, u = l.split("."), n = +i.groupSize, s = +i.secondaryGroupSize, c = i.groupSeparator || "", o = u[0], a = u[1], d = t.s < 0, E = d ? o.slice(1) : o, _ = E.length;
      if (s && (f = n, n = s, s = f, _ -= f), n > 0 && _ > 0) {
        for (f = _ % n || n, o = E.substr(0, f); f < _; f += n) o += c + E.substr(f, n);
        s > 0 && (o += c + E.slice(f)), d && (o = "-" + o);
      }
    ...
    var r, i, l, t, f, u, n, s, c, o, a, d, E = this, _ = E.c;
    if (e != null && (n = new g(e), !n.isInteger() && (n.c || n.s !== 1) || n.lt(M)))
      throw Error(C + "Argument " + (n.isInteger() ? "out of range: " : "not an integer: ") + j(n));
    if (!_) return new g(E);
    for (r = new g(M), c = i = new g(M), l = s = new g(M), d = G(_), f = r.e = d.length - E.e - 1, r.c[0] = pe[(u = f % O) < 0 ? O + u : u], e = !e || n.comparedTo(r) > 0 ? f > 0 ? r : c : n, u = H, H = 1 / 0, n = new g(d), s.c[0] = 0; o = p(n, r, 0, 1), t = i.plus(o.times(l)), t.comparedTo(e) != 1; )
      i = l, l = t, c = s.plus(o.times(t = c)), s = t, r = n.minus(o.times(t = r)), n = t;
    return t = p(e.minus(i), l, 0, 1), s = s.plus(t.times(c)), i = i.plus(t.times(l)), s.s = c.s = E.s, f = f * 2, a = p(c, l, f, S).minus(E).abs().comparedTo(
      p(s, i, f, S).minus(E).abs()
    ) < 1 ? [c, l] : [s, i], H = u, a;
  }, w.toNumber = function() {
    return +j(this);
    ...
    return t === null ? l ? (r = "Infinity", l < 0 && (r = "-" + r)) : r = "NaN" : (e == null ? r = t <= L || t >= y ? ne(G(i.c), t) : V(G(i.c), t, "0") : e === 10 && fe ? (i = U(new g(i), x + t + 1, S), r = V(G(i.c), i.e, "0")) : (k(e, 2, Q.length, "Base"), r = m(V(G(i.c), t, "0"), 10, e, l, !0)), l < 0 && i.c[0] && (r = "-" + r)), r;
...
function G(h) {
  for (var p, m, N = 1, w = h.length, M = h[0] + ""; N < w; ) {
    for (p = h[N++] + "", m = O - p.length; m--; p = "0" + p) ;
    M += p;
  }
...
function K(h, p) {
  var m, N, w = h.c, M = p.c, x = h.s, S = p.s, L = h.e, y = p.e;
  if (!x || !S) return null;
  if (m = w && !w[0], N = M && !M[0], m || N) return m ? N ? 0 : -S : x;
  if (x != S) return x;
  if (m = x < 0, N = L == y, !w || !M) return N ? 0 : !w ^ m ? 1 : -1;
  if (!N) return L > y ^ m ? 1 : -1;
  for (S = (L = w.length) < (y = M.length) ? L : y, x = 0; x < S; x++) if (w[x] != M[x]) return w[x] > M[x] ^ m ? 1 : -1;
  return L == y ? 0 : L > y ^ m ? 1 : -1;
}
function k(h, p, m, N) {
  if (h < p || h > m || h !== q(h))
    throw Error(C + (N || "Argument") + (typeof h == "number" ? h < p || h > m ? " out of range: " : " not an integer: " : " not a primitive number: ") + String(h));
}
function ie(h) {
  var p = h.c.length - 1;
...
function we(h) {
  let p = !1, m;
  return function(...N) {
    return p || (p = !0, m = h(...N)), m;
  };
}
function Ie(h, p) {
  return function(...m) {
    return p.call(this, h, ...m);
  };
}
function $e(h) {
  return h;
...
function me(h, p) {
  h.options.highlight ? h.options.highlight = Ie(h.options.highlight, (m, ...N) => p(...N) || m(...N)) : h.options.highlight = p;
}
const Be = we(async () => {
  const { EmojiConvertor: h } = await import("emoji-js");
  return new h();
...
function Te(h) {
  ...
  if (!p) return !1;
  const [m] = p;
  return h.pending += ge.replace_colons(m), h.pos += m.length, !0;
}
const Ae = {
  name: "emoji",
  async preload() {
  ...
  me(h, (m, N) => N === "mermaid" ? (p(), '<pre class="mermaid">' + Oe(m) + "</pre>") : "");
}, _e = {
  name: "mermaid",
  markdown: De
}, Le = {
...
let ve;
const Ce = we(async () => {
  const { default: h } = await import("@shikijs/markdown-it");
  ve = await h({
  ...
  h.use(ve), p && me(h, (...m) => p(...m));
}, xe = {
  name: "shiki",
  preload: ye,
  markdown: Ue
}, Fe = (h, { enableFeature: p }) => {
  me(h, (m, N, w) => N === "vega" ? (p(), `<div class="vega">${Oe(m)}</div>`) : "");
}, Me = {
  name: "vega",
  markdown: Fe
}, He = {
...
async function ze(h, p = te) {
  await Promise.all(p.map((m) => m.onMounted?.(h)));
}
class Xe {
  constructor(p) {
    this.plugins = p;
  ...
  process(p, m = this.plugins) {
  }
}
const Ge = we(async () => import("./markdown-it-cms-ArUl.js"));
class je {
  constructor(p, m) {
    this.plugins = p, this.md = m, p.forEach(({ name: N, markdown: w }) => {
      w && this.md.use(w, {
  ...
  render(p) {
    this.features = {};
    const m = this.md.render(p), N = this.plugins.filter(
...
`) : -1;
  if (m > 0) {
    const N = h.slice(4, m), { parse: w } = await import("yaml");
    try {
      p = w(N);
    } catch {
    }
...
export {
  ...
  Ve as parseFrontmatter,
  me as patchHighlight,
  He as pluginMap,
  ze as pluginMounted,
  ke as pluginPreload,
  We as renderMarkdown
};
