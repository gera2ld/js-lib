import { defer, type IDeferred } from "https://gitlab.com/gera2ld/common-lib/-/raw/main/src/util.ts";
export { simpleRequest } from "https://gitlab.com/gera2ld/common-lib/-/raw/main/src/http/request.ts";
export { defer, wrapFunction, type IDeferred } from "https://gitlab.com/gera2ld/common-lib/-/raw/main/src/util.ts";
type IFunction<U extends any[], V, T> = (this: T, ...args: U) => V;
export function limitConcurrency<T extends unknown[], U>(fn: (...args: T) => Promise<U>, concurrency: number) {
...
export function forwardFunction<U extends any[], V, T>(loader: () => Promise<IFunction<U, Promise<V>, T>>) {
