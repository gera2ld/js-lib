...
import { once as r } from "https://cdn.jsdelivr.net/npm/es-toolkit@1.27.0/+esm";
import { loadCSS as y, loadJS as i, fetchBlob as v } from "./util.js";
import { b64encode as b, encodeText as $, decodeText as M, b64decode as S } from "./base64.js";
...
@media (prefers-color-scheme: light) {
  ...
  () => i(
    "https://cdn.jsdelivr.net/combine/npm/vega@5.30.0,npm/vega-lite@5.21.0,npm/vega-embed@6.29.0"
  )
), C = {
  name: "vega",
  markdown: (t, { enableFeature: e, highlighters: n }) => {
  ...
  const { default: t } = await import("https://cdn.jsdelivr.net/npm/mermaid@11.4.0/dist/mermaid.esm.min.mjs"), e = window.matchMedia("(prefers-color-scheme: dark)");
  return t.initialize({
    startOnLoad: !1,
